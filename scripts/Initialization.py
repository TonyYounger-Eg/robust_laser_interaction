...
final_position = np.array([0.001528676599264145, -0.24211722612380981, 0.49880337715148926])
final_quaternion = np.array([0.8895708322525024,  0.2613868713378906, 0.12362505495548248, 0.35363471508026123])
